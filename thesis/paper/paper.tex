...
\todo[inline]{Kind of ridiculous to write basically the same premise repeatedly. Should probably write the general approach in demand-driven and just write the normal inequality here}
