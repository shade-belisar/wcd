...
\begin{equation*}
\begin{split}
c_1 = &\text{tripleEDB}(O, I, \text{propertyConstant}, X) \wedge \\
...
\begin{equation*}
\begin{split}
c_2 = &\text{tripleEDB}(O, I, \text{propertyConstant}, X) \wedge \\
...
&\text{require}(O, text{propertyConstant}, \text{requiredPropertyConstant})
\end{split}
\end{equation*}
...
\begin{equation*}
\begin{split}
c_1 = &\text{tripleEDB}(O, R, \text{propertyConstant}, I) \wedge \\
...
\begin{equation*}
\begin{split}
c_2 = &\text{tripleEDB}(O, R, \text{propertyConstant}, I) \wedge \\
...
\begin{equation*}
\begin{split}
\text{require\_second}&(S, \text{propertyConstant}) \leftarrow \\
&\text{next}(Q, R) \wedge \text{next}(R, S) \wedge \text{require}(Q, \text{propertyConstant}) \wedge t \wedge \\
&\text{tripleEDB}(R, I, \text{propertyConstant}, C)
\end{split}
\end{equation*}
\begin{equation*}
\text{require\_second}(S, \text{propertyConstant}) \leftarrow \text{next}(R, S) \wedge \text{require\_second}(R, \text{propertyConstant}) \wedge t
\end{equation*}
