 ...
 *
 */
public class CsvGzFileDataSource implements DataSource {
	public static final String CSV_FILE_EXTENSION = ".csv";
	public static final String CSV_GZ_FILE_EXTENSION = ".csv.gz";
	 ...
	 */
	public CsvGzFileDataSource(@NonNull final File csvFile) throws IOException {
		Validate.notNull(csvFile, "Data source file cannot be null!");
		Validate.isTrue(csvFile.getName().endsWith(CSV_FILE_EXTENSION) || csvFile.getName().endsWith(CSV_GZ_FILE_EXTENSION),
				"Expected .csv or .csg.gz extension for data source file [%s]!", csvFile);
	...
	String getFileNameWithoutExtension() {
		...
		if (fileName.endsWith(CSV_FILE_EXTENSION))
			lastIndexOf = fileName.lastIndexOf(CSV_FILE_EXTENSION);
		else
			lastIndexOf = fileName.lastIndexOf(CSV_GZ_FILE_EXTENSION);
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof CsvGzFileDataSource))
			return false;
		final CsvGzFileDataSource other = (CsvGzFileDataSource) obj;
